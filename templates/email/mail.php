                                            ...
                                            <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0;' align='left' bgcolor='#ffffff'>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                        <h1 class='h3' style='padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;' align='left'>Hola Erick !</h1>
                                                        ...
                                                        <h5 class='text-teal-700' style='color: #13795b; padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 20px; line-height: 24px; margin: 0;' align='left'>Una persona solicita tu atenci&#243;n desde tu p&#225;gina web. </h5>
                                                        ...
                                                        <div class='space-y-3'>
                                                        <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>Te comparto los datos de la persona interesada en tus servicios, porfavor ponte en contacto cuanto antes.</p>
                                                        ...
                                                        <ul class=''>
                                                            ...
                                                            <li>Email: $email</li>
                                                            <li>Servicio de Inter&#233;s: $optionProject</li>
                                                        </ul>
                                                        <table class='s-3 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                            <tbody>
                                                            <tr>
                                                        ...
                                                        <p class='text-gray-700' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='left'>
                                                            Pulsa el bot&#243;n para llamarlo y cierra la venta. &#201;xito !
                                                        </p>
                                                        </div>
                                                        <table class='s-5 w-full' role='presentation' border='0' cellpadding='0' cellspacing='0' style='width: 100%;' width='100%'>
                                                        <tbody>
                                                        ...
                                                        <table class='btn btn-primary' role='presentation' border='0' cellpadding='0' cellspacing='0' style='border-radius: 6px; border-collapse: separate !important;'>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <a href='tel:$telefono' target='_blank' style='color: #ffffff; font-size: 16px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 6px; line-height: 20px; display: block; font-weight: normal; white-space: nowrap; background-color: #0d6efd; padding: 8px 12px; border: 1px solid #0d6efd;'>&#161; Llamalo ahora !</a>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
